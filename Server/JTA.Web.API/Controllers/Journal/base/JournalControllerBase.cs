...
namespace DayJT.Web.API.Controllers.Journal
{
    ...
    {
        protected readonly ITradingJournalRepository _journalAccess;
        protected readonly ILogger<JournalControllerBase> _logger;
        protected readonly IMapper _mapper;

        public JournalControllerBase(ITradingJournalRepository journalAccess, ILogger<JournalControllerBase> logger, IMapper mapper)
        {
