...
const AboutDrawer = ({ opened, onClose }) => {
    return (
        ...
        >
            <Stack spacing="sm">
                <Text>
                    This is an online trading journal that allows you to record trades from an <b>idea stage</b> through building or reducing a position, performing evaluations, and finally <b>closing</b> the trade.
                </Text>

                <Text>
                    To add a new trade, click on <b>"Add a Trade"</b>. This creates a Trade Composition with an initial <b>Idea</b>.
                </Text>

                <Text>
                    Once all fields in the Idea are filled, you can initiate an <b>actual position</b>.
                </Text>
                ...
                <Text>
                    Once a trade component (Idea, Evaluation, Position) is expanded, hover your mouse at the bottom of the component to reveal the <b>Edit</b> icon. Click it to open a modal for editing the component.
                </Text>
